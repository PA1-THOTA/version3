...
function A() {
  const { productcategory, userdetails, setuserdetails } =
    ...
    <div className="itemspage">
      <div className="totalcontainer">
        ...
        <div className="contentcontainer">
          <div className="name">
            <h1 style={{ padding: "10px" }}><span style={{color:"black",textDecoration:"underline",textShadow:"2px 2px 5px brown"}}>NAME :-</span> {productcategory.itemname}</h1>
          </div>
          <div className="price">
            <h1 style={{ padding: "10px" }}>
            <span style={{color:"black",textDecoration:"underline",textShadow:"2px 2px 5px brown"}}>PRICE :-</span> ₹{productcategory.price}
            </h1>
          </div>
          <div className="desc">
            <h3 style={{ padding: "10px" }}>
            <span style={{color:"black",textDecoration:"underline",textShadow:"2px 2px 5px brown"}}>DESCRIPTION :-</span> {productcategory.des}
            </h3>
          </div>
        </div>
      </div>
